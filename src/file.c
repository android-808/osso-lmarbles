...
void
F_GetE(FILE * f, char *str, int flgs)
{
    int i = 0;
    char c;
    str[0] = 0;
...
int
F_CkE(char *str, int t, char *nm, char *v)
{
    char *n;
    ...
    else if (t & F_COM && F_FstC(str, 0) == '(' && F_LstC(str) == ')')
        return 1;
    return 0;
}
