...
/* 
 * ==================================================================== If
 * audio device was properly initiated this flag is set. If this flag is not
 * set; no action will be taken for audio.
 * ==================================================================== */
int audio_ok = 0;
/* 
 * ==================================================================== If
 * this flag is not set no sound is played.
 * ==================================================================== */
int sound_enabled = 1;
 ...
 * chunk ==================================================================== */
Sound_Chunk *
sound_chunk_load(char *file_name)
{
    char path[512];
    Mix_Chunk *chunk = 0;
...
#endif
    sprintf(path, "%s/%s", LMARBLESSOUNDSDIR, file_name);
...
void
sound_chunk_free(Sound_Chunk ** chunk)
{
    if (!audio_ok)
        return;
...
/* 
 * ==================================================================== Set
 * general volume of sounds. 0 - 127
 * ==================================================================== */
void
sound_volume(int level)
{
    if (!audio_ok)
        return;
    if (level < 0)
